export default function Page() {
  return (
    <div className="relative overflow-hidden bg-white">
      {/* Background */}
      <div className="absolute inset-0 -z-10 bg-linear-to-br from-indigo-50/40 via-white to-slate-50/40" />
      ...
      <div className="container mx-auto px-4 py-24">
        ...
        {/* Divider */}
        <div className="my-20 h-px bg-linear-to-r from-transparent via-gray-300 to-transparent" />
